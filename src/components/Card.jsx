...
//   const filtrarPlatos = (platos, categoria) => {
//     if (categoria === "Todos") {
//       return platos;
//     } else {
//       return platos.filter((plato) => plato.category === categoria);
//     }
//   };

//   return (
//     <div>
//       {/* No hay botones de filtro de categorías */}
//       <div className="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 ">
//         {filtrarPlatos(platos, categoriaSeleccionada).map((plato, index) => (
